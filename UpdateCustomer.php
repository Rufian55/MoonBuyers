	...
	<legend>Make Corrections</legend>
		<fieldset class="fieldset-left">
			<form method="post">
                ...
                <td>Planet:</td>
                <td><input name="Planet" type="text" id="Planet" maxlength="25" size="25" required value="<?php echo $Planet; ?>"></td>
				</tr>
                <tr>
				<td>Zip:</td>
...
if(isset($_POST['submit'])){
	...
	if(!($stmt->bind_param("sssssssiii", $_POST['Fname'], $_POST['Lname'], $_POST['Addr_1'], $_POST['Addr_2'], $_POST['City'], $_POST['State'], $_POST['Planet'], $_POST['Zip'], $_POST['Phone'], $_POST['id']))){
