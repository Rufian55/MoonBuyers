	...
	<legend>Data Entry</legend>
		<fieldset class="fieldset-left">
			<form method="post">
				...
				<tr>
                <td>Planet:</td>
                <td><input name="Planet" type="text" id="Planet" maxlength="25" size="25" autocomplete="off" required></td>
				</tr>
                <tr>
				<td>Zip:</td>
                <td><input name="Zip" type="text" id="Zip" maxlength="15" size="18" autocomplete="off" required></td>
                </tr>
                <tr>
				<td>Phone:</td>
